            ...
            __('Bot information', 'gpt-welcomer') => array(
                ...
                __('Microsoft', 'gpt-welcomer') => array(
                    __('Bingbot', 'gpt-welcomer') => array(
                        ...
                        __('bot_explain', 'gpt-welcomer') => __('Microsoft monopolizes advertising revenue by building AI systems that directly answer user queries using information from individual websites. At the moment, the only way to prevent AI from stealing content is to stop Bing search bots.', 'gpt-welcomer'),
                    ),
                ),
