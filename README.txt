...
Tags: bot, spam, chatGPT, bingbot, googlebot, Bing AI, AI, Artificial Intelligence, robot, robots.txt
...
gpt-welcomer is a WordPress plugin that limits content visibility for AI visitors like chatGPT or Bing AI bot, only a portion of the content is displayed in response.

== Description ==
With gpt-welcomer, you can express your intention that you do not want automatic information collection by AI and want a visit by a human.We had a Lightning Talk about the concept of this plugin at the Tokyo MeetUp commemorating the 20th anniversary of WordPress, and received generally positive impressions that this is an interesting challenge.
